package com.artostapyshyn.datesorter;
...
public class DateSorter {
    ...
    public Collection<LocalDate> sortDates(List<LocalDate> unsortedDates) {
        ...
        for (LocalDate date : unsortedDates){
            String monthName = date.getMonth().getDisplayName(TextStyle.FULL, Locale.ENGLISH).toLowerCase();
        ...
        withR.sort(Comparator.naturalOrder());
        withoutR.sort(Comparator.reverseOrder());
